...
Jump functions:
  Jump functions of caller  Lin_GetStatus/18:
  Jump functions of caller  Lin_SendFrame/17:
  Jump functions of caller  Lin_CheckWakeup/16:
  Jump functions of caller  Lin_WakeupInternal/15:
  Jump functions of caller  Lin_Init/14:
  Jump functions of caller  OsIf_Init/13:
  Jump functions of caller  Platform_Init/12:
  Jump functions of caller  Mcu_SetMode/11:
  Jump functions of caller  Mcu_DistributePllClock/10:
  Jump functions of caller  Mcu_GetPllStatus/9:
  Jump functions of caller  Mcu_InitClock/8:
  Jump functions of caller  Mcu_Init/7:
  Jump functions of caller  Port_Init/6:
  Jump functions of caller  main/4:
    callsite  main/4 -> Exit_Example/1 : 
       param 0: UNKNOWN
         value: 0x0, mask: 0x1
         Unknown VR
  Jump functions of caller  Exit_Example/1:
...
;; Function main (main, funcdef_no=2, decl_uid=7623, cgraph_uid=3, symbol_order=4) (executed once)
