...
Clock_Ip_CMU_ClockFailInt/1 (Clock_Ip_CMU_ClockFailInt) @05ee0c40
  Type: function
  ...
  Calls: 
Mcu_Cmu_ClockFail_IRQHandler/0 (Mcu_Cmu_ClockFail_IRQHandler) @05ee07e0
...
;; Function Mcu_Cmu_ClockFail_IRQHandler (Mcu_Cmu_ClockFail_IRQHandler, funcdef_no=0, decl_uid=6550, cgraph_uid=1, symbol_order=0)
