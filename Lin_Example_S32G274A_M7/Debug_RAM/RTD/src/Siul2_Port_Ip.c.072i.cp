...
Determining dynamic type for call: Siul2_Port_Ip_GetMSCRConfiguration (config_29(D), base_24(D), pin_26(D));
  Starting walk at: Siul2_Port_Ip_GetMSCRConfiguration (config_29(D), base_24(D), pin_26(D));
  instance pointer: config_29(D)  Outer instance pointer: config_29(D) offset: 0 (bits) vtbl reference: 
Determining dynamic type for call: Siul2_Port_Ip_GetMSCRConfiguration (config_29(D), base_24(D), pin_26(D));
  Starting walk at: Siul2_Port_Ip_GetMSCRConfiguration (config_29(D), base_24(D), pin_26(D));
...
Determining dynamic type for call: Siul2_Port_Ip_WriteIMCRConfiguration (config_41(D));
  Starting walk at: Siul2_Port_Ip_WriteIMCRConfiguration (config_41(D));
  instance pointer: config_41(D)  Outer instance pointer: config_41(D) offset: 0 (bits) vtbl reference: 
...
Jump functions:
  ...
  Jump functions of caller  Siul2_Port_Ip_PinInit/4:
    callsite  Siul2_Port_Ip_PinInit/4 -> Siul2_Port_Ip_WriteIMCRConfiguration/5 : 
...
overall_size: 280, max_new_size: 11001
...
Siul2_Port_Ip_GetPinConfiguration/13 (Siul2_Port_Ip_GetPinConfiguration) @04aa1a80
  ...
  Called by: 
  Calls: Siul2_Port_Ip_GetMSCRConfiguration/6 (55807732 (estimated locally),0.49 per call) 
...
Siul2_Port_Ip_GetMSCRConfiguration/6 (Siul2_Port_Ip_GetMSCRConfiguration) @050e87e0
  ...
  Called by: Siul2_Port_Ip_GetPinConfiguration/13 (55807732 (estimated locally),0.49 per call) 
  Calls: 
...
Siul2_Port_Ip_PinInit/4 (Siul2_Port_Ip_PinInit) @050e81c0
  ...
  Calls: Siul2_Port_Ip_WriteIMCRConfiguration/5 (1073741824 (estimated locally),1.00 per call) 
u32MaxPinConfigured/3 (u32MaxPinConfigured) @050ddf78
  ...
  Availability: available
  Varpool flags:
pPort_Setting/2 (pPort_Setting) @050ddee8
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: Siul2_Port_Ip_Init/7 (write)Siul2_Port_Ip_RevertPinConfiguration/12 (read)Siul2_Port_Ip_GetPinConfiguration/13 (read)
  Availability: available
  Varpool flags:
Port_au32Siul2BaseAddr/1 (Port_au32Siul2BaseAddr) @050dde58
  Type: variable definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: Siul2_Port_Ip_PinInit/4 (read)
  Availability: available
  Varpool flags: initialized read-only const-value-known

;; Function Siul2_Port_Ip_PinInit (Siul2_Port_Ip_PinInit, funcdef_no=1, decl_uid=6251, cgraph_uid=2, symbol_order=4)
...
;; Function Siul2_Port_Ip_Init (Siul2_Port_Ip_Init, funcdef_no=4, decl_uid=6123, cgraph_uid=5, symbol_order=7)
...
;; Function Siul2_Port_Ip_SetPullSel (Siul2_Port_Ip_SetPullSel, funcdef_no=5, decl_uid=6109, cgraph_uid=6, symbol_order=8)
...
;; Function Siul2_Port_Ip_SetOutputBuffer (Siul2_Port_Ip_SetOutputBuffer, funcdef_no=6, decl_uid=6114, cgraph_uid=7, symbol_order=9)
...
;; Function Siul2_Port_Ip_SetInputBuffer (Siul2_Port_Ip_SetInputBuffer, funcdef_no=7, decl_uid=6120, cgraph_uid=8, symbol_order=10)
...
;; Function Siul2_Port_Ip_SetPinDirection (Siul2_Port_Ip_SetPinDirection, funcdef_no=8, decl_uid=6127, cgraph_uid=9, symbol_order=11)
...
;; Function Siul2_Port_Ip_RevertPinConfiguration (Siul2_Port_Ip_RevertPinConfiguration, funcdef_no=9, decl_uid=6130, cgraph_uid=10, symbol_order=12)
...
;; Function Siul2_Port_Ip_GetPinConfiguration (Siul2_Port_Ip_GetPinConfiguration, funcdef_no=10, decl_uid=6134, cgraph_uid=11, symbol_order=13)
