...
;; Function Clock_Ip_Callback_DividerEmpty (Clock_Ip_Callback_DividerEmpty, funcdef_no=0, decl_uid=6550, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_SetCgmXDeDivWithoutPhase (Clock_Ip_SetCgmXDeDivWithoutPhase, funcdef_no=2, decl_uid=6554, cgraph_uid=3, symbol_order=2)
...
;; Function Clock_Ip_SetPlldigPll0divDeDivOutput (Clock_Ip_SetPlldigPll0divDeDivOutput, funcdef_no=3, decl_uid=6556, cgraph_uid=4, symbol_order=3)
...
;; Function Clock_Ip_SetCgmXDeDivStatWithoutPhase (Clock_Ip_SetCgmXDeDivStatWithoutPhase, funcdef_no=1, decl_uid=6552, cgraph_uid=2, symbol_order=1)
