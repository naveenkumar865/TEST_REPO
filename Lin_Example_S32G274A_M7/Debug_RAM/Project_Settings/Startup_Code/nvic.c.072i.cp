...
NVIC_SetPriority/3 (NVIC_SetPriority) @05ba3540
  ...
  Called by: 
  Calls: 
NVIC_DisableIRQ/2 (NVIC_DisableIRQ) @05ba32a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NVIC_EnableIRQ/1 (NVIC_EnableIRQ) @05ba3000
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NVIC_SetPriorityGrouping/0 (NVIC_SetPriorityGrouping) @05b7cee0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function NVIC_SetPriorityGrouping (NVIC_SetPriorityGrouping, funcdef_no=0, decl_uid=5409, cgraph_uid=1, symbol_order=0)
...
;; Function NVIC_EnableIRQ (NVIC_EnableIRQ, funcdef_no=1, decl_uid=5411, cgraph_uid=2, symbol_order=1)
...
;; Function NVIC_DisableIRQ (NVIC_DisableIRQ, funcdef_no=2, decl_uid=5413, cgraph_uid=3, symbol_order=2)
...
;; Function NVIC_SetPriority (NVIC_SetPriority, funcdef_no=3, decl_uid=5416, cgraph_uid=4, symbol_order=3)
