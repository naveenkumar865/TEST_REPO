...
Not considering Dem_BufferOverflow for cloning; -fipa-cp-clone disabled.
Not considering Dem_GetEventCount for cloning; -fipa-cp-clone disabled.
Not considering Dem_GetEvent for cloning; -fipa-cp-clone disabled.
Not considering Dem_ClearEvents for cloning; -fipa-cp-clone disabled.
Not considering Dem_TestLastReportErrorStatusPreExtData for cloning; -fipa-cp-clone disabled.
Not considering Dem_TestNoError for cloning; -fipa-cp-clone disabled.
Not considering Dem_TestLastReportErrorStatus for cloning; -fipa-cp-clone disabled.
...
Dem_OverflowEvent/12 (Dem_OverflowEvent) @05b361b0
  Type: variable
  ...
  Varpool flags:
Dem_au8ExtendedData/11 (Dem_au8ExtendedData) @05b2e9d8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Dem_EventStatus/10 (Dem_EventStatus) @05a57e58
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Dem_EventId/9 (Dem_EventId) @05a57e10
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Dem_numEventErrors/8 (Dem_numEventErrors) @05a57dc8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Sys_GetCoreID/7 (Sys_GetCoreID) @05b2a380
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
Dem_GetEventCount/5 (Dem_GetEventCount) @05a598c0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/7 (1073741824 (estimated locally),1.00 per call) 
Dem_GetEvent/4 (Dem_GetEvent) @05a59380
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/7 (1073741824 (estimated locally),1.00 per call) 
Dem_ClearEvents/3 (Dem_ClearEvents) @05a59d20
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/7 (1073741824 (estimated locally),1.00 per call) 
Dem_TestLastReportErrorStatusPreExtData/2 (Dem_TestLastReportErrorStatusPreExtData) @05a59a80
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/7 (10737418 (estimated locally),1.00 per call) 
Dem_TestNoError/1 (Dem_TestNoError) @05a597e0
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: 
  Calls: Sys_GetCoreID/7 (113634470 (estimated locally),1.00 per call) 
Dem_TestLastReportErrorStatus/0 (Dem_TestLastReportErrorStatus) @05a59540
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Referring: 
  Availability: available
  Function flags: count:78030430 (estimated locally) body optimize_size
  Called by: 
  Calls: Sys_GetCoreID/7 (78030430 (estimated locally),1.00 per call) 

;; Function Dem_TestLastReportErrorStatus (Dem_TestLastReportErrorStatus, funcdef_no=0, decl_uid=5658, cgraph_uid=1, symbol_order=0)
...
;; Function Dem_TestNoError (Dem_TestNoError, funcdef_no=1, decl_uid=5660, cgraph_uid=2, symbol_order=1)
...
;; Function Dem_TestLastReportErrorStatusPreExtData (Dem_TestLastReportErrorStatusPreExtData, funcdef_no=2, decl_uid=5665, cgraph_uid=3, symbol_order=2)
...
Dem_TestLastReportErrorStatusPreExtData (Dem_EventIdType Dem_EventIdRaw, Dem_EventStatusType Dem_EventStatusRaw, uint8 * Dem_pui8_PreExtData, uint8 Dem_PreExtDataSize)
{
  ...
  <bb 5> [local count: 2611014]:
  # counterDown_15 = PHI <counterDown_20(4)>
  goto <bb 11>; [100.00%]

  <bb 6> [local count: 21125475]:
  # DEBUG BEGIN_STMT
  ...
  <bb 7> [local count: 4275796]:
  # DEBUG BEGIN_STMT
  // predicted unlikely by continue predictor.
  goto <bb 10>; [100.00%]

  <bb 8> [local count: 16849679]:
  # DEBUG BEGIN_STMT
  _9 = (int) u8Counter_22;
  ...
  <bb 9> [local count: 11120788]:
  # DEBUG BEGIN_STMT
  # DEBUG bRetValue => 0

  <bb 10> [local count: 21125475]:
...
;; Function Dem_ClearEvents (Dem_ClearEvents, funcdef_no=3, decl_uid=5667, cgraph_uid=4, symbol_order=3)
...
;; Function Dem_GetEvent (Dem_GetEvent, funcdef_no=4, decl_uid=5671, cgraph_uid=5, symbol_order=4)
...
;; Function Dem_GetEventCount (Dem_GetEventCount, funcdef_no=5, decl_uid=5673, cgraph_uid=6, symbol_order=5)
...
;; Function Dem_BufferOverflow (Dem_BufferOverflow, funcdef_no=6, decl_uid=5675, cgraph_uid=7, symbol_order=6)
