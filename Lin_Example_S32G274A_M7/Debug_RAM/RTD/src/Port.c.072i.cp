...
Port_Ipw_Init/9 (Port_Ipw_Init) @05e2fd20
  ...
  Calls: 
Port_Config/8 (Port_Config) @05e28948
  Type: variable
...
Port_pConfigPtr/1 (Port_pConfigPtr) @05e28168
...
;; Function Port_Init (Port_Init, funcdef_no=1, decl_uid=6213, cgraph_uid=2, symbol_order=2)
...
;; Function Port_SetPinDirection (Port_SetPinDirection, funcdef_no=2, decl_uid=6216, cgraph_uid=3, symbol_order=3)
...
;; Function Port_SetPinMode (Port_SetPinMode, funcdef_no=3, decl_uid=6219, cgraph_uid=4, symbol_order=4)
...
;; Function Port_RefreshPortDirection (Port_RefreshPortDirection, funcdef_no=4, decl_uid=6223, cgraph_uid=5, symbol_order=5)
...
;; Function Port_GetVersionInfo (Port_GetVersionInfo, funcdef_no=5, decl_uid=6221, cgraph_uid=6, symbol_order=6)
