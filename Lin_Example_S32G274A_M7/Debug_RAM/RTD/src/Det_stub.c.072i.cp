...
Det_TransientFaultId/18 (Det_TransientFaultId) @05ad6c18
  Type: variable
  ...
  Varpool flags:
Det_TransientApiId/17 (Det_TransientApiId) @05ad6bd0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_TransientInstanceId/16 (Det_TransientInstanceId) @05ad6b88
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_TransientModuleId/15 (Det_TransientModuleId) @05ad6b40
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_RuntimeErrorId/14 (Det_RuntimeErrorId) @05ad6750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_RuntimeApiId/13 (Det_RuntimeApiId) @05ad6708
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_RuntimeInstanceId/12 (Det_RuntimeInstanceId) @05ad66c0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_RuntimeModuleId/11 (Det_RuntimeModuleId) @05ad6678
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_ErrorId/10 (Det_ErrorId) @05ad6288
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_ApiId/9 (Det_ApiId) @05ad6240
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_InstanceId/8 (Det_InstanceId) @05ad61f8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
Det_ModuleId/7 (Det_ModuleId) @05ad61b0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
...
;; Function Det_TestLastReportError (Det_TestLastReportError, funcdef_no=0, decl_uid=5676, cgraph_uid=1, symbol_order=0)
...
;; Function Det_TestLastReportRuntimeError (Det_TestLastReportRuntimeError, funcdef_no=1, decl_uid=5681, cgraph_uid=2, symbol_order=1)
...
;; Function Det_TestLastReportTransientFault (Det_TestLastReportTransientFault, funcdef_no=2, decl_uid=5686, cgraph_uid=3, symbol_order=2)
...
;; Function Det_TestNoError (Det_TestNoError, funcdef_no=3, decl_uid=5688, cgraph_uid=4, symbol_order=3)
...
;; Function Det_TestNoRuntimeError (Det_TestNoRuntimeError, funcdef_no=4, decl_uid=5690, cgraph_uid=5, symbol_order=4)
...
;; Function Det_TestNoTransientFault (Det_TestNoTransientFault, funcdef_no=5, decl_uid=5692, cgraph_uid=6, symbol_order=5)
